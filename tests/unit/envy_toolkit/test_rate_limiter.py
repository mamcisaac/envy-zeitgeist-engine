...
from envy_toolkit.rate_limiter import RateLimiter, RateLimiterRegistry, RateLimitStats
...
class TestRateLimiterRegistry:
    ...
    async def test_get_or_create(self) -> None:
        ...
        assert limiter2.rate == 5.0  # Should keep original rate
    ...
    def test_get_all_stats(self) -> None:
        ...
        assert stats["api1"]["rate"] == 5.0
        assert stats["api2"]["rate"] == 10.0
